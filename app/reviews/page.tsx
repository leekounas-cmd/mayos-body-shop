...
export default function ReviewsPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero — dark for contrast, matches trust strip */}
      <div className="bg-[#111111] pt-28 pb-16 sm:pt-32 sm:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-start gap-8">
            <div className="bg-[#E53E3E] p-6 text-center min-w-[100px] flex-shrink-0">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-white/50 text-xs font-bold tracking-[0.25em] uppercase">Google Reviews</p>
              </div>
              <h1
              ...
              <p className="text-white/60 mt-4 text-lg">Dallas has been trusting Mayo&apos;s since 1998.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reviews.map((review) => (
              <div key={review.id} className="bg-[#F9F9F9] border border-[#EEEEEE] p-7 flex flex-col">
          ...
          <div className="text-center mt-16">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border border-[#DDDDDD] hover:border-[#E53E3E] text-[#111111] hover:text-[#E53E3E] text-sm px-8 py-3 uppercase tracking-wider transition-colors cursor-pointer font-semibold"
            >
