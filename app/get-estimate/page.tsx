    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-24 space-y-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              {trustPoints.map((point) => (
                <div key={point.label} className="bg-[#F5F5F5] p-5 border-t-2 border-t-[#E53E3E]">
                  <p className="text-[#111111] font-bold text-sm" style={{ fontFamily: 'var(--font-heading)' }}>{point.label}</p>
                  <p className="text-[#666666] text-xs mt-1">{point.sub}</p>
                </div>
              ))}
            </div>
            ...
            <div className="bg-white border border-[#EEEEEE] p-6">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[#111111] font-bold text-lg ml-1" style={{ fontFamily: 'var(--font-heading)' }}>4.9</span>
              </div>
            ...
            <div className="border-t border-[#EEEEEE] pt-8">
              <p className="text-[#888888] text-sm mb-4">Prefer to call? We&apos;re here:</p>
              <a
          ...
          {/* Right — form */}
          <div className="bg-[#F9F9F9] border border-[#EEEEEE] p-8 lg:p-10">
