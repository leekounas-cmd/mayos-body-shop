    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-24 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              {trustPoints.map((point) => (
                <div key={point.label} className="bg-[#F8F8F8] rounded-xl p-5">
            ...
            <div className="bg-white rounded-xl border border-[#F0F0F0] shadow-sm p-6">
              <div className="flex items-center gap-1.5 mb-2">
                ...
                <span className="text-[#111111] font-bold text-xl ml-1" style={{ fontFamily: 'var(--font-heading)' }}>4.9</span>
              </div>
            ...
            <div className="pt-2">
              ...
              >
                <div className="w-12 h-12 bg-[#E53E3E] rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          {/* Right — form */}
          <div className="bg-[#F8F8F8] rounded-xl p-8 lg:p-10">
