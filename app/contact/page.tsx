        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#F8F8F8] rounded-xl p-6">
                ...
                <div className="divide-y divide-[#EEEEEE]">
                  <div className="flex justify-between py-3">
                    <span className="text-[#111111] font-medium text-sm">Monday – Friday</span>
                    <span className="text-[#666666] text-sm">9:00 AM – 7:00 PM</span>
                  </div>
                  <div className="flex justify-between py-3">
                    <span className="text-[#111111] font-medium text-sm">Saturday</span>
                    <span className="text-[#666666] text-sm">9:00 AM – 4:00 PM</span>
                  </div>
                  <div className="flex justify-between py-3">
                    <span className="text-[#111111] font-medium text-sm">Sunday</span>
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-[#111111] hover:text-[#E53E3E] transition-colors font-semibold cursor-pointer mb-5 text-sm"
                >
            ...
            <div>
              ...
              <div className="mt-6 p-5 bg-[#FEF2F2] rounded-xl border border-[#FECACA]">
