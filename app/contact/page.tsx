        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-10">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-[#F5F5F5] p-6">
                  ...
                  <p className="text-[#111111] font-semibold">314 Harbin St</p>
                  <p className="text-[#111111] font-semibold">Dallas, TX 75208</p>
                </div>
                <div className="bg-[#F5F5F5] p-6">
                  <p className="text-[#E53E3E] text-xs font-bold uppercase tracking-[0.2em] mb-3">Phone</p>
                  <a href="tel:+12147440766" className="text-[#111111] font-bold text-xl hover:text-[#E53E3E] transition-colors cursor-pointer block" style={{ fontFamily: 'var(--font-heading)' }}>
                    (214) 744-0766
                  </a>
              ...
              <div>
                ...
                <div className="divide-y divide-[#EEEEEE]">
                  <div className="flex justify-between py-3">
                    ...
                    <span className="text-[#666666]">9:00 AM – 7:00 PM</span>
                  </div>
                  <div className="flex justify-between py-3">
                    <span className="text-[#111111] font-medium">Saturday</span>
                    <span className="text-[#666666]">9:00 AM – 4:00 PM</span>
                  </div>
                  <div className="flex justify-between py-3">
                    <span className="text-[#111111] font-medium">Sunday</span>
                    <span className="text-[#888888]">Closed</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 text-[#111111] hover:text-[#E53E3E] transition-colors font-semibold cursor-pointer mb-5"
                >
                ...
                <div className="aspect-video overflow-hidden border border-[#EEEEEE]">
                  <iframe
            ...
            <div>
              ...
              <div className="mt-6 p-5 bg-[#FEF2F2] border-l-4 border-l-[#E53E3E]">
